...
async function carregarAmbientes() {
  ...
  try {
    ...
    const novosFades = container.querySelectorAll(".fade-up");
    novosFades.forEach((el) => {
      observer.observe(el);
    });
  } catch (erro) {
    console.error("Erro geral ao carregar ambientes:", erro);
    mostrarMensagemGrid(container, "Falha ao carregar ambientes.");
  }
}
